...
export const Header = () => {
  ...
  return (
    <header className='sticky top-0 z-50'>
      ...
      >
        <div className='relative mx-auto flex min-h-12 w-full max-w-[1200px] items-center justify-between'>
          {/* left */}
          <NgOoLogo isDark />
          ...
          {/* right */}
          <div className='z-20 flex h-full items-center justify-center gap-2 py-2'>
            {/* authen button */}
            <AuthenButton />
