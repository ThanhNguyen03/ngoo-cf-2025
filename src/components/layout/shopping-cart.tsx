      ...
      {cartAmount > 0 && (
        <div className='pointer-events-none sticky bottom-20 z-50 mx-auto max-w-[1200px]'>
          <div className='relative z-50 ml-auto size-fit'>
            ...
            <Link
              href='/checkout'
              className='center rounded-10 border-primary-500/15 from-primary-500/15 group to-primary-500/2 hover:from-secondary-500/5 hover:to-secondary-500/15 pointer-events-auto flex size-fit border bg-white bg-linear-to-br p-3 shadow-[0px_4px_12px_0px_rgba(9,9,11,0.02)] duration-700'
            >
              <BasketIcon
                size={24}
                weight='fill'
