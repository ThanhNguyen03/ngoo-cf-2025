...
export const NewCollection = forwardRef<HTMLDivElement, TNewCollectionProps>(
  (
    { setSelectedProduct, selectedProduct, inCollectionView, inSellerView },
    ref,
  ) => {
    ...
    const [
      ...
      flatCloudRef,
    ] = useParallaxLayer<HTMLImageElement>(containerRef, cloudConfigs)
...
NewCollection.displayName = 'NewCollection'
