...
export const CheckoutInfo = () => {
  ...
  return (
    <>
      ...
      {loading && (
        <div className='center bg-dark-600/30 fixed top-0 left-0 z-[999] h-screen w-screen flex-col gap-4 overflow-hidden backdrop-blur-md md:gap-6'>
          ...
          <div className='mx-auto w-full max-w-[500px] px-6'>
            <div className='center rounded-2 relative h-1 w-full items-start overflow-hidden bg-white'>
