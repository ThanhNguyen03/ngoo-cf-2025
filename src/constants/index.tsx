...
import { ENewProduct, TNavigationItem, TNewCollection } from '@/types'
import {
  ChatsCircleIcon,
  FacebookLogoIcon,
  GithubLogoIcon,
...
export const LIST_NEW_PRODUCT: TNewCollection[] = [
  {
...
export const NEW_PRODUCT_DATA: Record<
  ENewProduct,
  { model: string; bgClassName: string; buttonClassName: string }
> = {
  [ENewProduct.Cherry]: {
