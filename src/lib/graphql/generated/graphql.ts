...
export type PaymentUserHistoryQuery = {
  __typename?: 'Query'
  paymentUserHistory: {
    __typename?: 'TUserPaymentResponse'
    paymentId: string
...
export type ListUserPaymentHistoryQuery = {
  __typename?: 'Query'
...
export const ApproveCodPaymentDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ApproveCODPayment' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
export const GetAllOrderDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllOrder' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GetAllOrderQuery, GetAllOrderQueryVariables>
export const GetUserOrderDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetUserOrder' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GetUserOrderQuery, GetUserOrderQueryVariables>
export const PaymentUserHistoryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PaymentUserHistory' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  PaymentUserHistoryQuery,
  PaymentUserHistoryQueryVariables
>
...
export const ListUserPaymentHistoryDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ListUserPaymentHistory' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  ListUserPaymentHistoryQuery,
  ListUserPaymentHistoryQueryVariables
>
